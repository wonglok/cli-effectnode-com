            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Auto-Save UI / Color Pickers</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Tired of Copying Values into JSON Files or Managing Multiple Versions? Our sliders and UI comes with auto save. So, you dont need to copy json values everytime you chagne one item.
                  </p>
                </div>
              </div>
            </div>
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">3D Layout Made Eaiser with GUI</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Doing WebGL 3D layout for Objects can sometime be hard. Let's make use of Top, Left, Perspective, Camera View to help layout different objects
                  </p>
                </div>
              </div>
            </div>
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Crossdevice Realtime Preview</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Color Picker,s Value Sliders and more are realtime in sync with each other with the WebSocket to sync across tablets and Phones. When we build our project it can also auto include JSON of production use.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div v-if="false" class="flex flex-wrap items-center mt-32">
            <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
              ...
              <h3 class="text-3xl mb-2 font-semibold leading-normal">
                SDK for your creative speed.
              </h3>
              <p
                class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700"
              >
                Don't let your creative ideas stop. Make them into reality.
              </p>
              <p
          ...
          <div class="flex flex-wrap">
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                <img
                  alt="..."
                  dsrc="../assets/img/team-1-800x800.jpg"
            ...
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                <img
                  alt="..."
                  dsrc="../assets/img/team-2-800x800.jpg"
                  class="shadow-lg rounded-full max-w-full mx-auto"
                  style="max-width: 120px;"
                />
                <div class="pt-6 text-center">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                <img
                  alt="..."
                  dsrc="../assets/img/team-3-800x800.jpg"
                  class="shadow-lg rounded-full max-w-full mx-auto"
                  style="max-width: 120px;"
                />
                <div class="pt-6 text-center">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                <img
                  alt="..."
                  dsrc="../assets/img/team-4-470x470.png"
                  class="shadow-lg rounded-full max-w-full mx-auto"
                  style="max-width: 120px;"
                />
                <div class="pt-6 text-center">
