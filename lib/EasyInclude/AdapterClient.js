...
export class AdapterClient {
  ...
  setupSocket () {
    this.client.socket.on('restore-snap', ({ restore }) => {
      this.db.set('current', restore)
        .write()
    })
  ...
  restoreSnap ({ restore }) {
    ...
    this.client.socket.emit(`restore-snap`, { restore, device: this.device })
  }
